...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "ImagePickerSheetViewController/ImagePickerSheet/ImagePickerSheet/ImagePickerSheetViewController/SupplementaryView.bundle"
  install_resource "LFImagePickerController/LFImagePickerController/LFImagePickerController/class/LFImagePickerController.bundle"
